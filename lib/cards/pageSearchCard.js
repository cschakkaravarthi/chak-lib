...
exports.PageSearchCard = function (props) {
    var title = props.title, MainLink = props.MainLink, searchSummary = props.searchSummary, departmentName = props.departmentName, _a = props.searchKeyword, searchKeyword = _a === void 0 ? '' : _a, _b = props.isFetching, isFetching = _b === void 0 ? false : _b;
            ...
            react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "align-items-center d-flex" },
                react_1["default"].createElement(Card_1["default"].Body, { className: "justify-content-between flex-column" },
                    react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12" },
                        ...
                        react_1["default"].createElement(Card_1["default"].Text, { className: "mt-2 font-weight-lighter text-uppercase department" }, !isFetching ? departmentName : react_1["default"].createElement(react_loading_skeleton_1["default"], { width: 200 })),
                        react_1["default"].createElement(Col_1["default"], { xs: "12", xl: "12", className: "p-0 font-weight-lighter" }, !isFetching ? searchSummary : react_1["default"].createElement(react_loading_skeleton_1["default"], { width: 220, count: 3 }))),
